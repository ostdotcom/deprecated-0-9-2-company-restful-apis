 ...
 *                  clientId - Client Id whose salt will be used for encryption.
 *
 * @constructor
 */
const AddressEncryptorKlass = function(clientId){
  const oThis = this;
...
AddressEncryptorKlass.prototype = {
  ...
  encrypt: async function(dataToEncrypt){
    ...
    var response = await _private.fetchClientSalt(oThis.clientId);
