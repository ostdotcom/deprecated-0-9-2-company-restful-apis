...
AddressEncryptorKlass.prototype = {
  ...
  _fetchAddressSalt: async function() {
    ...
    let managedAddressSaltCacheObject = oThis.ic().getManagedAddressSaltCache();
    let obj = new managedAddressSaltCacheObject({ id: oThis.managedAddressSaltId });
...
InstanceComposer.registerShadowableClass(AddressEncryptorKlass, 'getAddressEncryptorKlass');
