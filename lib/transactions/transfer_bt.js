...
TransferBt.prototype = {
  ...
  _validateAction: async function () {
    ...
    var cacheObj = await (new ClientTransactionTypeFromIdCache(
  ...
  updateParentTransactionLog: function (statusString, failedResponse) {
    const oThis = this
      , statusInt = new transactionLogConst().invertedStatuses[statusString];
    ...
    return new OSTStorage.TransactionLogModel(
      {client_id: oThis.clientId, ddb_service: ddbServiceObj}).batchPutItem([dataToUpdate]);
  },
