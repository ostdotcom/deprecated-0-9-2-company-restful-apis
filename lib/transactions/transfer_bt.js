...
const openStPayments = require('@openstfoundation/openst-payments')
  ...
  , OSTStorage = require('@openstfoundation/openst-storage')
;
...
const rootPrefix = '../..'
  ...
  , TransferStPrimeKlass = require(rootPrefix + '/lib/transactions/stPrime_transfer_for_approve')
...
const TransferBt = function (params) {
  ...
  oThis.postReceiptProcessParams = null;
};
...
TransferBt.prototype = {
    ...
    return Promise.resolve(responseHelper.successWithData(
      {
        ...
        from_uuid: oThis.fromUuid, to_uuid: oThis.toUuid, transaction_kind: oThis.transactionTypeRecord.name
      }));
  },
  ...
  _validateAction: async function () {
    ...
    var cachedResp = await (new ClientTransactionTypeFromIdCache(
  ...
  updateParentTransactionLog: function (statusString, failedResponse) {
    ...
    var dataToUpdate = {transaction_uuid: oThis.transactionUuid, status: statusInt,
      ...
      post_receipt_process_params: oThis.postReceiptProcessParams};

    if (failedResponse) {
      dataToUpdate['error_code'] = failedResponse.code;
    }
    return new OSTStorage.TransactionLogModel(
      {client_id: oThis.clientId, ddb_service: ddbServiceObj, auto_scaling: autoScalingServiceObj}).updateItem(dataToUpdate);
  },
  ...
  performTransactionSteps: async function () {
    ...
    console.log("-1----------------------------needApproveBT-", JSON.stringify(needApproveBT));
    ...
    if (needApproveBT) {
      ...
      console.log("-2----------------------------approveForBrandedTokenResponse-", JSON.stringify(approveForBrandedTokenResponse));
    }
    ...
    console.log("-3----------------------------setWorkerUserResponse-", JSON.stringify(setWorkerUserResponse));
    ...
    console.log("-4----------------------------sendAirdropPayResponse-", JSON.stringify(sendAirdropPayResponse));
    return Promise.resolve(responseHelper.successWithData({}));
  },
  ...
  refillGasForUser: async function () {
    ...
    var inputParams = {
      ...
      receiver_uuid: oThis.fromUuid, method_args: {amount: approveAmount}
    };
  ...
  setWorkerUser: async function () {
    ...
    console.log("----setWorkerUser---------------------------cacheFetchResponse-", cacheFetchResponse);
    if (cacheFetchResponse.isFailure()) {
    ...
    console.log("----setWorkerUser---------------------------workerUuid-", workerUuid);
    oThis.workerUser = cacheFetchResponse.data[workerUuid];

    console.log("----setWorkerUser---------------------------oThis.workerUser-", oThis.workerUser);
    return Promise.resolve(responseHelper.successWithData({}));
  },
  ...
  sendAirdropPay: async function () {
    ...
    console.log("-3--1--------------------------reserveUser-", JSON.stringify(reserveUser));
    if (!oThis.workerUser || !reserveUser) {
      await oThis.updateParentTransactionLog(transactionLogConst.failedStatus, {code: 's_t_et_22', msg: "Worker or reserve user not found. "});
      return Promise.resolve(responseHelper.error({
    ...
    console.log("-3--2--------------------------ostValue-", JSON.stringify(ostValue));
    ...
    console.log("-3--5--------------------------payMethodParams-", JSON.stringify(payMethodParams));
    ...
    console.log("-3--6--------------------------payResponse-", JSON.stringify(payResponse));
    ...
    oThis.postReceiptProcessParams = payResponse.data.post_receipt_process_params;
