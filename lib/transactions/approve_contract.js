...
ApproveContractKlass.prototype = {
    ...
    return oThis.asyncPerform()
      .catch(function (error) {
        if (responseHelper.isCustomResult(error)) {
          ...
          return responseHelper.error("l_t_ac_1", "Unhandled result", null, {}, {sendErrorEmail: false});
        }
      });
  },
  ...
  _approve: async function() {
    ...
    oThis.approveTransactionHash = approveResponse.data.transactionReceipt.data.rawTransactionReceipt.transactionHash;
