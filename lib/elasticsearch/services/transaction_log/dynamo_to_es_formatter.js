...
rules.push( {"inKey": "ca",   "outKey": "created_at", "formatter": dynamoHelpers.toValidNumber } );

rules.push( {"inKey": "ua",   "outKey": "updated_at", "formatter": dynamoHelpers.toValidNumber } );
