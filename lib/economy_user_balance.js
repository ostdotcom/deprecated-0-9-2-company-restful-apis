...
economyUserBalance.prototype = {
  ...
  perform: async function () {
    ...
    const airdropBalanceResponse = await openStPaymentsAirdropManager.getAirdropBalance(
      chainInteractionConstants.UTILITY_CHAIN_ID, airdropContractAddress, oThis.ethereumAddresses);
