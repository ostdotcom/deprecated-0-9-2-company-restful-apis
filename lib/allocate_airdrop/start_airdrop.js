...
StartAllocateAirdropKlass.prototype = {
  ...
  validateReserveBalance: async function () {
    ...
    logger.debug('-------------------------------oThis.airdropParams.airdrop_amount-', oThis.airdropParams.airdrop_amount);
    logger.debug('-------------------------------brandedTokenBalanceResponse-', brandedTokenBalanceResponse);
