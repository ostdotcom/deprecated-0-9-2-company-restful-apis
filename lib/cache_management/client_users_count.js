...
const rootPrefix = '../..'
    ...
    , managedAddrObj = new ManagedAddressKlass()
    , responseHelper = require(rootPrefix + '/lib/formatter/response')
;

/**
 * @constructor
 * @augments ClientUsersCntCacheKlass
 *
...
const ClientUsersCntCacheKlassPrototype = {
  ...
  fetchDataFromSource: async function() {
    ...
    const oThis = this
        , response = await managedAddrObj.getFilteredActiveUsersCount({client_id: oThis.clientId})
