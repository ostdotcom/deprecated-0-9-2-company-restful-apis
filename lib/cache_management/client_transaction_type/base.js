 ...
 *
 */
const ClientTransactionTypeCacheBaseKlass = function(params) {
  const oThis = this;
...
ClientTransactionTypeCacheBaseKlass.prototype = Object.create(baseCache.prototype);

const ClientTransactionTypeCacheBaseKlassPrototype = {
  /**
...
Object.assign(ClientTransactionTypeCacheBaseKlass.prototype, ClientTransactionTypeCacheBaseKlassPrototype);

InstanceComposer.registerShadowableClass(ClientTransactionTypeCacheBaseKlass, 'getClientTransactionTypeCacheBase');

module.exports = ClientTransactionTypeCacheBaseKlass;
