...
clientSecretsCache.prototype.setCacheKey = function() {
  ...
  oThis.cacheKey = oThis._cacheKeyPrefix() + "cs_" + oThis.apiKey ;
...
clientSecretsCache.prototype.fetchDataFromSource = async function() {
  ...
  var decryptedSalt = await kmsWrapper.decrypt(dbRecord["api_salt"]);
  ...
  var data = {clientId: dbRecord["client_id"], apiKey: oThis.apiKey, apiSecret: apiSecretEncr};
