...
const BaseCacheManagementKlass = function(params) {
  ...
  if (oThis.cacheType === cacheManagementConst.memcached || oThis.cacheType === cacheManagementConst.redis) {
    oThis.cacheObject = oThis
      .ic()
      .getClientSpecificCacheProvider()
      .getInstance(oThis.cacheType, oThis.consistentBehavior);
  } else if (oThis.cacheType === cacheManagementConst.in_memory) {
    oThis.cacheObject = require(rootPrefix + '/lib/providers/in_memory_cache');
  } else if (oThis.cacheType === cacheManagementConst.shared_memcached) {
    oThis.cacheObject = require(rootPrefix + '/lib/providers/shared_memcached');
  } else {
...
InstanceComposer.registerShadowableClass(BaseCacheManagementKlass, 'getBaseCacheManagement');
