...
const baseCacheManagementKlass = function(params) {
  ...
  oThis.cacheImplementer = new openStCache.cache(coreConstants.SAAS_ONLY_CACHE_ENGINE, true);
...
baseCacheManagementKlass.prototype = {
  ...
  _sharedCacheKeyPrefix: function () {
    return 'ca_sa_shared_' + coreConstants.ENVIRONMENT_SHORT + '_' + coreConstants.SUB_ENVIRONMENT_SHORT + '_';
  }
