...
const rootPrefix = '../..'
  ...
  , cacheImplementer = require(rootPrefix + '/lib/cache_management/engine/general')
;
...
BaseCacheManagementKlass.prototype = {
  ...
  _sharedCacheKeyPrefix: function () {
    return coreConstants.SHARED_MEMCACHE_KEY_PREFIX + coreConstants.ENVIRONMENT_SHORT + '_' + coreConstants.SUB_ENVIRONMENT_SHORT + '_';
  }
