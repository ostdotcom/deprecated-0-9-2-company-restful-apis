...
ActionFormatterKlass.prototype = {
  ...
  perform: async function () {
    ...
    if(oThis.params.currency == clientTxTypesConst.usdCurrencyType && !commonValidator.isVarNull(oThis.params.value_in_usd)){
      amount = oThis.params.value_in_usd;
    } else if (oThis.params.currency == clientTxTypesConst.btCurrencyType && !commonValidator.isVarNull(oThis.params.value_in_bt_wei)) {
      amount = basicHelper.convertToNormal(oThis.params.value_in_bt_wei);
    } else if (oThis.params.amount){
