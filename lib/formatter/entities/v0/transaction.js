...
TransactionFormatterKlass.prototype = {
  ...
  perform: async function() {
    ...
    if (
      !oThis.params.hasOwnProperty('transaction_uuid') ||
      !oThis.params.hasOwnProperty('from_uuid') ||
      !oThis.params.hasOwnProperty('to_uuid') ||
    ...
    formattedTransaction.transaction_fee = oThis.params.transaction_fee || null;
    formattedTransaction.block_number = oThis.params.block_number || null;
    formattedTransaction.bt_transfer_value = oThis.params.amount_in_wei || null;
    formattedTransaction.bt_commission_amount = oThis.params.commission_amount_in_wei || null;
