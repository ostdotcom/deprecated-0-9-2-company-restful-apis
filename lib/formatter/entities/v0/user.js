...
UserFormatterKlass.prototype = {
  ...
  perform: async function () {
    ...
    if (!oThis.params.hasOwnProperty(uuid) || !oThis.params.hasOwnProperty(addresses)
        || !oThis.params.hasOwnProperty(name) || !oThis.params.hasOwnProperty(airdropped_tokens)
    ...
    formattedUser.address = oThis.params.addresses[0][1];
