...
UserFormatterKlass.prototype = {
  ...
  perform: async function() {
    ...
    if (
      ...
      !oThis.params.hasOwnProperty('total_airdropped_tokens') ||
    ...
    formattedUser.addresses = [[chainIntConstants.UTILITY_CHAIN_ID, oThis.params.address]];
    ...
    return Promise.resolve(responseHelper.successWithData(formattedUser));
  }
};
