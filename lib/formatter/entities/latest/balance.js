...
BalanceFormatterKlass.prototype = {
  ...
  perform: async function() {
    ...
    formattedBalance.available_balance = basicHelper.convertToNormal(oThis.params.tokenBalance.toString(10));
    formattedBalance.airdropped_balance = basicHelper.convertToNormal(oThis.params.balanceAirdropAmount.toString(10));
    formattedBalance.token_balance = basicHelper.convertToNormal(oThis.params.availableBalance.toString(10));
