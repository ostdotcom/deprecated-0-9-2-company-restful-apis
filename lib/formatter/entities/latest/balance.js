...
BalanceFormatterKlass.prototype = {
  ...
  perform: async function () {
    ...
    formattedBalance.available_balance = oThis.params.tokenBalance.toString(10);
    formattedBalance.airdropped_balance = oThis.params.balanceAirdropAmount.toString(10);
    formattedBalance.token_balance = oThis.params.availableBalance.toString(10);
