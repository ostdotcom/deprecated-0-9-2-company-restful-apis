...
ActionFormatterKlass.prototype = {
  ...
  perform: async function(){
    ...
    if (!oThis.params.hasOwnProperty('client_id') || !oThis.params.hasOwnProperty('name') || !oThis.params.hasOwnProperty('kind')
        || !oThis.params.hasOwnProperty('currency_type') || !oThis.params.hasOwnProperty('currency_value')
    ...
    formattedAction.id = oThis.params.client_id;
    formattedAction.name = oThis.params.name;
    formattedAction.kind = oThis.params.kind;
    formattedAction.currency = oThis.params.currency_type;
    formattedAction.amount = oThis.params.currency_value;
