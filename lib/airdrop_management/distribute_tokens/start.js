...
startKlass.prototype = {
  ...
  _startTokenTransfer: async function () {
    ...
    if (response.isFailure()) {
      ...
      oThis.tokensTransferedTransactionHash = response.data.rawTransactionReceipt.transaction_hash;
  ...
  _startContractApprove: async function () {
    ...
    if (response.isFailure()) {
      ...
      oThis.contractApproveTransactionHash = response.data.rawTransactionReceipt.transaction_hash;
