  ...
  startApproval: async function () {
    ...
    while(true){
      ...
      for(var i=0; i<userRecords.length; i++){
        ...
        console.log("userRecord.properties-----", userRecord.properties);
        console.log("(new managedAddressModel().invertedProperties[managedAddressesConst.bTContractApproved])-----", (new managedAddressModel().invertedProperties[managedAddressesConst.bTContractApproved]));
      ...
      // Start Approve now.
      await oThis.refillGasForUser(approveForUuids);

      await oThis.approveForBrandedToken(approveForUuids);
