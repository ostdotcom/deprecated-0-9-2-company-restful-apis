...
baseKlass.prototype = {
  ...
  _checkReserveAddressBalance: async function () {
    ...
    // fetch reserve address balance
    // TODO: Use platform balance method
    const params = {
      balances_to_fetch: {
        utility: {
          address_uuid: managedAddressObj.uuid,
          balance_types: [oThis.clientBrandedTokenObj.symbol]
        }
      }, client_id: oThis.clientBrandedTokenObj.client_id
    };
