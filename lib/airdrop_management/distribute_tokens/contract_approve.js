...
contractApproveKlass.prototype = {
  ...
  perform: async function () {
    ...
    const managedAddressSqlResponse = await new ManagedAddressModel().getByIds([oThis.clientBrandedTokenObj.airdrop_holder_managed_address_id])
