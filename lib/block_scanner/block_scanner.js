...
const BlockScannerKlass = function(params) {
  ...
  oThis.benchmarkFilePath = '/Users/dhananjaypatil/openst-setup/logs/block_scanner_benchmark-1000.csv';
...
BlockScannerKlass.prototype = {
  ...
  warmUpWeb3Pool: async function() {
    ...
    console.log('====config', oThis.ic().configStrategy);
  ...
  generateToUpdateDataForUnKnownTx: async function() {
    ...
    let params = {
      blockNoDetailsMap: oThis.transactionHashes, //@dhananjay - check this later
