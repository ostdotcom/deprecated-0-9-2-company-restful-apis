...
const BlockScannerKlass = function(params) {
  ...
  oThis.benchmarkFilePath = logsFolderAbsolutePath + '/block_scanner_benchmark-1000.csv';
...
BlockScannerKlass.prototype = {
  ...
  processTransactions: async function() {
    ...
    await processNewBlocksAsync().catch(function(error) {
      logger.error('executables/block_scanner/block_scanner.js::processNewBlocksAsync::catch'); //TODO: change this
      logger.error(error);
    });
  },
