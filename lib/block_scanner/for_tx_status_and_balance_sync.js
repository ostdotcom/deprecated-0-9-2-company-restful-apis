 ...
 * @param params.web3InteractFactory - web3InteractFactory object
 * @constructor
 */
...
const BlockScannerKlass = function(params) {
  ...
  oThis.web3InteractFactory = params.web3InteractFactory;

  oThis.benchmarkFilePath = params.benchmarkFilePath;
  oThis.delegatorTimestamp = params.delegatorTimestamp;
...
BlockScannerKlass.prototype = {
  ...
  getTransactionReceipts: async function() {
    ...
    loadPerConnection = TXS_PER_BATCH;
