...
AssignShards.prototype = {
  ...
  asyncPerform: async function () {
    ...
    await new OSTStorage.TokenBalanceModel({
      erc20_contract_address: oThis.tokenErc20Address,
      ddb_service: ddbServiceObj,
      auto_scaling: autoscalingServiceObj
    }).allocate();

    // await new OSTStorage.TransactionTypeModel({
  ...
  _checkForExistingShards: async function () {
    ...
    // const hasAllocatedShardRsp = await new OSTStorage.TransactionLogModel({
    //   client_id: oThis.clientId,
    //   ddb_service: ddbServiceObj,
    //   auto_scaling: autoscalingServiceObj
    // }).hasAllocatedShard();
    ...
    const hasAllocatedShardRsp = await new OSTStorage.TokenBalanceModel({
      erc20_contract_address: oThis.tokenErc20Address,
      ddb_service: ddbServiceObj,
      auto_scaling: autoscalingServiceObj
    }).hasAllocatedShard();
