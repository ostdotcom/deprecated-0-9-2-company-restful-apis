...
SetupAirdropContractClass.prototype = {
  ...
  getAddresses: async function () {
    ...
    if (!oThis.brandedTokenId || !oThis.clientId) {
      return Promise.reject(responseHelper.error('l_am_s_1', 'Mandatory params missing.', null, [],
    ...
    if (brandedToken.client_id != oThis.clientId) {
      return Promise.reject(responseHelper.error('l_am_s_3', 'Unauthorised request', null, [],
        {sendErrorEmail: false}));
    }
