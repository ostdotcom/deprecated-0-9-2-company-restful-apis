...
SetupAirdropContractClass.prototype = {
  ...
  setCriticalChainInteractionLog: async function () {
    ...
    const oThis = this
        ...
        , criticalChainInteractionLogs = await criticalChainInteractionLogObj.getByIds([
  ...
  updateCriticalChainInteractionLog: async function (idToUpdate, dataToUpdate) {
    ...
    await criticalChainInteractionLogObj.update(dataToUpdate).where({id: idToUpdate}).fire();
   ...
   *
   */
  insertCriticalChainInteractionLog: async function (idToUpdate, dataToUpdate) {
    ...
    const oThis = this
      ...
      , status = criticalChainInteractionLogModelObj.invertedStatuses[criticalChainInteractionLogConst.queuedStatus]
    ;
