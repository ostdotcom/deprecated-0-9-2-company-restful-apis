  ...
  propose: async function () {
    ...
    if (proposeResponse.isFailure()) {
      ...
      const errorRsp = responseHelper.error({
        ...
        debug_options: {err: proposeResponse.err || {}, data: proposeResponse.data || {}},
        error_config: errorConfig
      });
      ...
      const getStatus = async function() {
        if (maxAttempts > 0) {
          ...
          const errorRsp = responseHelper.error({
            ...
            debug_options: {err: getRegistrationStatusResponse.err || {}, data: getRegistrationStatusResponse.data || {}},
            error_config: errorConfig
          });
