...
const BrandedTokenKlassPrototype = {
  ...
  validateAndSanitize: function () {
    ...
    oThis.toStakeAmount = oThis.parentCriticalChainInteractionLog.request_params.stake_and_mint_params.ost_to_stake_to_mint_bt;

    if(!oThis.toStakeAmount || !oThis.clientId || !oThis.brandedTokenId){
      return Promise.reject(responseHelper.error('sam_bt_1', 'Invalid Params', null, {},
