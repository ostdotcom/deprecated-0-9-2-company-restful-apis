...
StakeAndMintRouterKlass.prototype = {
  ...
  asyncPerform: async function () {
    ...
    if((oThis.currentStep === 'approve_for_stake_and_mint') && oThis.status === 'done') {
      ...
      if (oThis.stakeAndMintParams.bt_to_mint && basicHelper.convertToBigNumber(oThis.stakeAndMintParams.bt_to_mint).gt(zeroBn)) {
        oThis.queueStartStakeForBT();
      }
      if (oThis.stakeAndMintParams.st_prime_to_mint && basicHelper.convertToBigNumber(oThis.stakeAndMintParams.st_prime_to_mint).gt(zeroBn)) {
