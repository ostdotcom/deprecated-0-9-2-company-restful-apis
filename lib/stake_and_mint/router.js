...
StakeAndMintRouterKlass.prototype = {
  ...
  setParentCriticalInteractionLog: async function() {
    ...
    console.log('parentCriticalChainInteractionLog', parentCriticalChainInteractionLog);
    console.log('criticalChainInteractionLogs', criticalChainInteractionLogs);
    ...
    oThis.chainId = parentCriticalChainInteractionLog.chain_id;

    oThis.parentCriticalInteractionLog = parentCriticalChainInteractionLog;

    console.log('oThis.chainId', oThis.chainId);
    console.log('oThis.parentCriticalInteractionLog', oThis.parentCriticalInteractionLog);
  },
