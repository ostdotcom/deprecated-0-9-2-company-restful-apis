...
identifierKeys[configStrategy.rmq] = ['OST_RMQ_USERNAME', 'OST_RMQ_HOST', 'OST_RMQ_PORT'];

identifierKeys[configStrategy.shared_rmq] = ['OST_SHARED_RMQ_USERNAME', 'OST_SHARED_RMQ_HOST', 'OST_SHARED_RMQ_PORT', 'OST_SHARED_RMQ_CLUSTER_NODES'];
const statuses = {
