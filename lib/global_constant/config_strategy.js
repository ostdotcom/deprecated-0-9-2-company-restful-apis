...
const keysToBeKeptUnencrypted = {
  ...
  utility_geth: ['read_only', 'read_write', 'OST_UTILITY_CHAIN_ID'],
  utility_constants: [
  ...
  rmq: ['OST_RMQ_USERNAME', 'OST_RMQ_HOST', 'OST_RMQ_PORT', 'OST_RMQ_HEARTBEATS', 'OST_RMQ_CLUSTER_NODES'],
  shared_rmq: [
...
const keysToEncrypt = {
  ...
  rmq: ['OST_RMQ_PASSWORD'],
  shared_rmq: ['OST_SHARED_RMQ_PASSWORD']
};
...
const identifierKeys = {
  ...
  rmq: ['OST_RMQ_USERNAME', 'OST_RMQ_HOST', 'OST_RMQ_PORT', 'OST_RMQ_CLUSTER_NODES'],
  shared_rmq: ['OST_SHARED_RMQ_USERNAME', 'OST_SHARED_RMQ_HOST', 'OST_SHARED_RMQ_PORT', 'OST_SHARED_RMQ_CLUSTER_NODES']
};
...
whiteListedKeys[configStrategy.utility_geth] = ['read_only', 'read_write'];

whiteListedKeys[configStrategy.rmq] = ['OST_RMQ_CLUSTER_NODES'];
