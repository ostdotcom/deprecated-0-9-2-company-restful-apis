...
Web3InteractHelperKlass.prototype = {
  ...
  getInstance: function(chainType) {
    const oThis = this,
      existingInstance = oThis.instances[chainType],
      configStrategy = oThis.ic().configStrategy;

    if (existingInstance) return existingInstance;

    let provider =
      chainType == 'utility' ? configStrategy.OST_UTILITY_GETH_WS_PROVIDER : configStrategy.OST_VALUE_GETH_WS_PROVIDER;
    ...
    oThis.instances[chainType] = newInstance;
