 ...
 * Wrapper for AWS KMS
 *
 * @module lib/authentication/kms_wrapper
 *
 * * Author: Pankaj
 * * Date: 16/01/2018
 * * Reviewed by:
 ...
 *
 * @Constructor
 * @param purpose - this is the purpose for accessing the KMS service - clientValidation OR managedAddresses
 */
...
const _private = {
  ...
  getKey: function (purpose) {
    ...
    } else if(purpose === "managedAddresses"){
