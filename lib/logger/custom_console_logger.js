...
CustomConsoleLoggerKlass.prototype = {
  ...
  step: function () {
    var oThis = this;
    var args  = [oThis.getPrefix( appendRequest(this.STEP_PRE))];
  ...
  info: function () {
    var oThis = this;
    var args  = [oThis.getPrefix( appendRequest(this.INFO_PRE) )];
    args = args.concat(Array.prototype.slice.call(arguments));
    args.push(this.CONSOLE_RESET);
    console.log.apply(console, args);
  },
  ...
  error: function () {
    var oThis = this;
    var args  = [oThis.getPrefix(appendRequest(this.ERR_PRE))];
    args = args.concat(Array.prototype.slice.call(arguments));
    args.push(this.CONSOLE_RESET);
    console.log.apply(console, args);
  },
  ...
  notify: function (code, msg, data, backtrace) {
    var oThis =  this;
    var args  = [oThis.getPrefix(appendRequest(this.NOTE_PRE))];
    args = args.concat(Array.prototype.slice.call(arguments));
    args.push(this.CONSOLE_RESET);
    console.log.apply(console, args);
  ...
  warn: function () {
    var oThis =  this;
    var args  = [oThis.getPrefix(appendRequest(this.WARN_PRE))];
    args = args.concat(Array.prototype.slice.call(arguments));
    args.push(this.CONSOLE_RESET);
    console.log.apply(console, args);
  },
  ...
  win: function () {
    var oThis =  this;
    var args  = [oThis.getPrefix(appendRequest(this.WIN_PRE))];
    args = args.concat(Array.prototype.slice.call(arguments));
    args.push(this.CONSOLE_RESET);
    console.log.apply(console, args);
  },
  ...
  log: function () {
    var oThis =  this ;
    var args  = [oThis.getPrefix(appendRequest(this.LOG_PRE))];
    args = args.concat(Array.prototype.slice.call(arguments));
    args.push(this.CONSOLE_RESET);
    console.log.apply(console, args);
  },
  ...
  debug: function () {
    var oThis =  this;
    var args  = [oThis.getPrefix(appendRequest(this.DEBUG_PRE))];
    args = args.concat(Array.prototype.slice.call(arguments));
    args.push(this.CONSOLE_RESET);
    console.log.apply(console, args);
  },
  ...
  getPrefix : function( prefix ){
    return pid + colonSeparator + prefix;
  }
