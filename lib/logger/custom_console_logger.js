...
var coreConstants, getNamespace, requestNamespace, openSTNotification, packageName, responseHelper;
  ...
  notify: function(code, msg, errData, debugData) {
    ...
    openSTNotification.publishEvent.perform({
      ...
      message: {
        ...
        payload: {
          subject:
            packageName + ' :: ' + coreConstants.ENVIRONMENT + ' - ' + coreConstants.SUB_ENVIRONMENT + '::' + code,
          body:
            ' Request id: ' +
            requestId +
            '\n\n Debug data: ' +
