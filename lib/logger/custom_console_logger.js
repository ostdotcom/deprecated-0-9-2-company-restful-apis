...
let coreConstants, getNamespace, requestNamespace, packageName, responseHelper, ConnectionTimeoutConst;
...
CustomConsoleLoggerKlass.prototype = {
  ...
  /*notify: async function(code, msg, errData, debugData) {
    ...
    openSTNotification.publishEvent
      ...
      .catch(function(err) {
        oThis.error('Message for airdrop router was not published. Payload: ', payload, ' Error: ', err);
      });
  },*/
