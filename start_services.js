...
StartServicesKlass.prototype = {
  ...
  perform: async function() {
    ...
    var cmd =
      ...
      ' >> ' +
      homeAbsolutePath +
      '/openst-setup/logs/register_branded_token.log';
    servicesList.push(cmd);
    oThis._asyncCommand(cmd);
    ...
    var cmd =
      ...
      ' >> ' +
      homeAbsolutePath +
      '/openst-setup/logs/stake_and_mint.log';
    servicesList.push(cmd);
    oThis._asyncCommand(cmd);
    ...
    var cmd =
      ...
      ' >> ' +
      homeAbsolutePath +
      '/openst-setup/logs/stake_and_mint_processor.log';
    servicesList.push(cmd);
    oThis._asyncCommand(cmd);

    logger.step('** Starting Stake Hunter Intercom');
    var cmd =
      'node executables/inter_comm/stake_hunter.js ' +
      homeAbsolutePath +
      '/openst-setup/logs/stake_hunter.data' +
      ' >> ' +
      homeAbsolutePath +
      '/openst-setup/logs/stake_hunter.log';
    servicesList.push(cmd);
    oThis._asyncCommand(cmd);
    ...
    var cmd =
      ...
      ' >> ' +
      homeAbsolutePath +
      '/openst-setup/logs/block_scanner_execute_transaction.log';
    servicesList.push(cmd);
    oThis._asyncCommand(cmd);
    ...
    var cmd = 'node app.js' + ' >> ' + homeAbsolutePath + '/openst-setup/logs/node_app.log';
    servicesList.push(cmd);
    oThis._asyncCommand(cmd);
