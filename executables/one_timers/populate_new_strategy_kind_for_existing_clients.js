 ...
 *
 * node executables/one_timers/populate_new_strategy_kind_for_existing_clients.js [1]
 */
...
function PopulateNewKindForClients() {
  const oThis = this;
}

PopulateNewKindForClients.prototype = {
  /**
   * Perform
   *
   * @return {promise}
...
const usageDemo = function() {
  logger.log('usage:', 'node ./executables/one_timers/populate_new_strategy_kind_for_existing_clients.js');
};

const object = new PopulateNewKindForClients();
object
  .perform()
  .then(function(a) {
