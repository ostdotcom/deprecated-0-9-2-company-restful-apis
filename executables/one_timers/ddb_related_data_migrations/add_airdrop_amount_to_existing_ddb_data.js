...
//   stpTransferTransactionType = parseInt(
//     transactionLogConst.invertedTransactionTypes[transactionLogConst.stpTransferTransactionType]
//   ),
...
//   autoscalingServiceObj = openSTStorage.autoScalingService;
//
// const Limit = 20;
//
...
//       if (dynamoDBFormatter.toNumber(items[i].tt === stpTransferTransactionType)) {
//         continue;
//       }
...
//
//       if (dynamoDBFormatter.toNumber(item.tt === stpTransferTransactionType)) {
//         continue;
//       }
//
...
//       let clientBrandedTokenRows = await new ClientBrandedTokenModel()
//         .select('id,airdrop_holder_managed_address_id')
//         .where(['id IN (?)', missedClientTokenIds])
//         .fire();
...
//       }
//
//       let managedAddressRows = await new ManagedAddressModel()
//         .select('id,ethereum_address')
//         .where(['id IN (?)', airdropBudgetHolderIds])
//         .fire();
...
//         oThis.clientTokenIdBudgetHolderAddrMap[buffer['id']] =
//           managedAddressIdAddressMap[buffer['airdrop_holder_managed_address_id']];
//       }
//     }
//
...
//   logger.log(
//     'usage:',
//     'node ./executables/ddb_related_data_migrations/add_airdrop_amount_to_existing_ddb_data.js configStrategy_file_path shardName'
//   );
// };
//
