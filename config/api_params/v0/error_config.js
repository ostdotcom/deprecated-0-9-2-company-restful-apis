...
const errorConfig = {
  ...
  "invalid_username": {
    "parameter": "name",
    "message": "Must be a minimum of 3 characters, a maximum of 20 characters, and can contain only letters, numbers, and spaces, along with other common sense limitations."
  },
  ...
  "insufficient_airdrop_amount": {
    "parameter": "amount",
    "code": "invalid",
    "message": "Available token amount is insufficient. Please mint more tokens or reduce the amount to complete the process."
  },
  ...
  "inappropriate_transaction_name": {
    "parameter": "name",
    "message": "Must be a minimum of 3 characters, a maximum of 20 characters, and can contain only numbers, letters, and spaces, along with other common sense limitations."
  },
