  ...
  "inappropriate_username":
    {
      "parameter":
        "name",
      "message":
        "Come on, the name you entered is inappropriate. Please choose a nicer word."
    }
  ,
  "invalid_transaction_name":
    {
      "parameter":
        "name",
      "message":
        "Only letters, numbers and spaces allowed. (3 to 20 characters)."
    }
  ,
  ...
  "invalid_order_by_user_list":
    {
      ...
      "code":
        "invalid",
      "message":
        "order the list by 'created' (default) or 'name'"
    }
  ,
  "invalid_order":
    {
      ...
      "code":
        "invalid",
      "message":
        "order in 'desc' (default) or 'asc' order."
    }
  ,
  "invalid_id_user_list":
    {
      ...
      "code":
        "invalid",
      "message":
        "id should have comma seperated values (max 100)"
    }
  ,
  ...
  "invalid_airdropped_filter":
    {
      ...
      "code":
        "invalid",
      "message":
        "airdropped can be True of False"
    }
  ,
  "invalid_client_id":
    {
  ...
  "airdropped_filter_empty_list":
    {
      ...
      "code":
        "invalid",
      "message":
        "No users found to airdrop for the filters selected"
    }
  ,
  ...
  "invalid_amount_arbitrary_combination":
    {
      ...
      "code":
        "invalid",
      "message":
        "Amount and arbitrary amount combination is not valid"
    }
  ,
  "invalid_commission_arbitrary_combination":
    {
      ...
      "code":
        "invalid",
      "message":
        "Commission percent and arbitrary commission combination is not valid"
    }
  ,
  ...
  "invalid_airdrop_uuids":
    {
      ...
      "code":
        "invalid",
      "message":
        "Some of user ids passed for Airdrop are invalid."
    }
  ,
  "invalid_order_by_airdrop_list":
    {
      ...
      "code":
        "invalid",
      "message":
        "order the list by 'created' (default) for Now."
    }
  ,
  "invalid_id_filter":
    {
      ...
      "code":
        "invalid",
      "message":
        "id should have comma separated airdrop ids (max 100)"
    }
  ,
  "invalid_current_status_airdrop_list":
    {
      ...
      "code":
        "invalid",
      "message":
        "current status should have comma seperated status filters (eg: incomplete,processing,complete,failed)"
    }
  ,
  "invalid_order_by":
    {
      "parameter":
        "order_by",
      "message":
        "Order by not valid on this field"
    }
  ,
  "invalid_arbitrary_amount_filter":
    {
      "parameter":
        "arbitrary_amount",
      "message":
        "Filter on arbitrary_amount can have only one value"
    }
  ,
  "invalid_arbitrary_commission_filter":
    {
      ...
      "code":
        "invalid",
      "message":
        "Filter on arbitrary_commission can have only one value and should be a valid boolean"
    }
  ,
  ...
  "invalid_currency_type":
    {
      ...
      "code":
        "invalid",
      "message":
        "Must be either 'USD' (fixed) or 'BT' (floating)."
    }
  ,
  "invalid_currency_filter":
    {
      "parameter":
        "currency",
      "message":
        "Filter on currency can have only one value"
    }
  ,
  "invalid_amount":
    {
  ...
  "invalid_transaction_get":
    {
      "parameter":
        "transaction_type",
      "message":
        "Requested transfer data for invalid transaction type."
    }
  ,
  "invalid_transfer_amount":
    {
      "parameter":
        "amount",
      "message":
        "Transfer amount should be between 0 and 100 ST Prime. Amount should be in Weis."
    }
  ,
  "invalid_to_address":
    {
